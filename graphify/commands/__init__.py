...
def _cmd_extract(cmd: str) -> None:
    from graphify.cli import _GRAPHIFY_OUT, _StageTimer, _prune_graph_json_sources, _stale_graph_sources, _stamped_manifest_files
